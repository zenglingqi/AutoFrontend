...
export default function PhoneListCard({ phones, lang = "en", onUpdated }: Props) {
        ...
        <div className="bg-white dark:bg-zinc-900 border border-neutral-100 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm transition-all">
            ...
            <div className="px-6 py-5 border-b border-neutral-100 dark:border-zinc-800">
                ...
                <p className="mt-1 text-xs text-neutral-500 font-light">
                    {"Manage your mobile numbers for security and updates."}
                </p>
            </div>
            ...
            <div className="p-6">
                ...
                <div className="space-y-3">
                    {phones.map((item) => (
                        <div
                            key={item.id}
                            className="flex items-center justify-between p-4 rounded-xl border border-neutral-50 dark:border-zinc-800 bg-neutral-50/30 dark:bg-zinc-800/20 transition-colors"
                        >
                            ...
                            {/* 默认/主手机号标签 */}
                            {item.primary && (
                                <span className="text-[10px] px-2 py-0.5 rounded-full border border-neutral-200 dark:border-zinc-700 text-neutral-400 uppercase tracking-tighter">
                                    {"Primary"}
                                </span>
                            )}
                        </div>
